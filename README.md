...
## This plugin has been cloned from: https://github.com/RaresAil/homebridge-tp-link-tapo/
# v4.1.2 is the current as-is version of the plugin from @RaresAil. All Credit thus far goes to him.
